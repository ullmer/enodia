# https://github.com/pygame/pygame/blob/main/examples/sprite_texture.py  
...
tex = Texture.from_surface(renderer, load_img("acc-clem-02.jpg"))
...
sprite = Something(Image(tex, (0, 0, tex.width / 5, tex.height / 5)))
sprite.rect.x = 250
sprite.rect.y = 50
